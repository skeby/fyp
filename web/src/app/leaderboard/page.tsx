  ...
  return (
    <main className="px-5 py-4 min-[370px]:px-4 sm:px-6 sm:py-7">
      <div className="max-w-res">
        <h2 className="text-primary flex flex-col justify-between gap-x-2 gap-y-0.5 font-medium min-[370px]:flex-row">
          <span className="text-2xl">Leaderboard</span>
          <div className="text-muted-foreground flex flex-row-reverse items-center justify-end gap-x-2 min-[370px]:flex-row min-[370px]:justify-start">
      ...
      >
        ...
        <div className="flex min-w-0 items-center gap-4">
          ...
          <div className="flex min-w-0 flex-col">
            <div title={username} className="truncate font-medium">
              {username}
            </div>
            <div
              title={first_name}
