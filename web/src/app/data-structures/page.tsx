...
const quizData = {
  ...
  description:
    "This topic is a test of your understanding in concepts in data structures",
  questions: [
    {
      id: 1,
...
const DataStructures = () => {
  ...
  const isCorrect = () => {
    return selectedAnswer === quizData.questions[currentQuestion].correctAnswer
  }
      ...
      {quizState === "intro" && (
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold">{quizData.topic}</h1>
          </div>
